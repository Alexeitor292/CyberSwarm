...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 pb-16 pt-8 px-6 border-t border-primary/5">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-2 h-2 bg-primary/30 rotate-45" />
          <span className="font-heading text-sm font-semibold text-muted-foreground/75">
            {footer.brand_name || 'CyberSwarm'}
          </span>
        </div>
        <p className="font-mono text-xs text-muted-foreground/65 text-center">{copyrightText}</p>

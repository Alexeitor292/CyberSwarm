    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <p className="font-mono text-xs tracking-[0.3em] text-primary/85 uppercase mb-3">
            // Broadcast
          </p>
        ...
        <div className="glass rounded-lg overflow-hidden scanline relative">
          {/* Terminal header */}
          <div className="flex items-center gap-2 px-5 py-3 border-b border-primary/45 bg-background/55">
            <Terminal className="w-3.5 h-3.5 text-primary/85" aria-hidden="true" />
                ...
                {updates.map((update, i) => (
                  ...
                  >
                    {update.priority === 'urgent' ? (
                      ...
                      <Info className="w-3.5 h-3.5 text-primary/85 shrink-0 mt-0.5" aria-hidden="true" />
                    )}
